 ...
 */
public class BitRate extends Activity {
    ...
    Spinner bitrate_spinner;
    @Override
    public void onCreate(Bundle savedInstanceState) {

        super.onCreate(savedInstanceState);
        setContentView(R.layout.bit_rate);

        //menu_list_spinner = (Spinner) findViewById(R.id.spinner_menu);
        bitrate_spinner = (Spinner) findViewById(R.id.spinner_menu);
        ...
        //Log.e("Lemme-action",""+action);
        if (action.equals("brate")) {
            //Your code
            start_Notification();
            try {
                selectItem();
