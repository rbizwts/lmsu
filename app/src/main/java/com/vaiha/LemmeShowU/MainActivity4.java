    ...
    public void onCreate(Bundle savedInstanceState) {
      ...
      // DisplayMetrics metrics = new DisplayMetrics();
       ...
       /* WindowManager windowmanager = (WindowManager) getApplicationContext().getSystemService(Context.WINDOW_SERVICE);
        ...
        DISPLAY_HEIGHT = Math.round(metrics.heightPixels / metrics.density);

        DISPLAY_WIDTH = Math.round(metrics.widthPixels / metrics.density);
        Toast.makeText(getApplicationContext(),"heights--"+DISPLAY_HEIGHT+"--"+DISPLAY_WIDTH,Toast.LENGTH_LONG).show();
        mScreenDensity = metrics.densityDpi;
        msg = (TextView) findViewById(R.id.status);
        Button waitButton = (Button) findViewById(R.id.waitButton);
        SupportClass.t = msg;*/
       ...
       /* DisplayMetrics metrics = new DisplayMetrics();
        ...
        // Toast.makeText(getApplicationContext(),"width--"+DISPLAY_WIDTH+"width--"+DISPLAY_HEIGHT,Toast.LENGTH_LONG).show();
        //mScreenDensity = metrics.densityDpi;
        SupportClass.a = MainActivity4.this;
            ...
            public void run() {
                        ...
                        //run on ui thread
                {
                    public void run() {
                      ...
                      /*  if (temp2) {
                             Toast.makeText(getApplicationContext(),"temp2--"+temp2,Toast.LENGTH_SHORT).show();
                            //  Log.e("test","1");
                    ...
                    if(SupportClass.movie) {
                        Toast.makeText(getApplicationContext(), "SupportClass--" + SupportClass.movie, Toast.LENGTH_SHORT).show();
                        //  Log.e("test","1");
                        msg.setText("Screen capture in Progress");
