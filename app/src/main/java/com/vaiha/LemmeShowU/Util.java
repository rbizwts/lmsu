...
public class Util {
    ...
    public static boolean validate(String paramString1, String paramString2, String paramString3) {
        if (paramString1.equals("") || paramString2.equals("") || paramString3.equals("")) {
            Toast.makeText(c.getApplicationContext(), "Please Enter All Fields", Toast.LENGTH_SHORT).show();
            return false;
        }
        return true;
    }
