    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if(isStoragePermissionGranted()){
           Toast.makeText(MainActivity2.this,"Permission granted",Toast.LENGTH_LONG).show();
            //access=true;
          /*  myDir = new File(output_path + "/images");
            myDir.mkdirs();
            ...
            Toast.makeText(MainActivity2.this,"Permission not granted",Toast.LENGTH_LONG).show();
           //access=false;
        ...
        SupportClass.a = MainActivity2.this;
      ...
      /*  if (frame_val == 0.5) {
        ...
        if (frame_val == 0.5) {
         ...
         if (frame_val == 0.25) {
            ...
            // Toast.makeText(getApplicationContext(),""+frame_val,Toast.LENGTH_LONG).show();
             Log.e("for0.25",""+frame_val);
             k = 1000000 * (long)2.5;
             //k = (long) (1000000 / SupportClass.g_frames);
         }
         if (frame_val == 1) {
...
//
       //}
        ...
        /*File gallery = new File("/sdcard/LemmeShowU/images");
        if (!gallery.exists()) {
            gallery.mkdir();
        }else{
            Toast.makeText(getApplicationContext(),"Folder Already exists",Toast.LENGTH_LONG).show();
        }
        ...
        final String fname = "Image-" + s + mi + ".jpg";
        ...
        if (!sharedPrefManager.isGrantPermission()) {
            ...
            alertDialog.setNegativeButton("CANCEL", new DialogInterface.OnClickListener() {
                public void onClick(DialogInterface dialog, int which) {
                    ...
                    Toast.makeText(MainActivity2.this, "LemmeShowU requires your permission to capture a recording of your screen. Please restart and provide permission to unleash the power!", Toast.LENGTH_LONG).show();
                    dialog.cancel();
                    SupportClass.a.finish();
                   // minimizeApp();
                }
