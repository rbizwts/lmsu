package com.vaiha.LemmeShowU.utilities.waves;
...
/**
 * Created by Harish on 2014/10/15.
 */
public class WaveView extends LinearLayout {
    ...
    public WaveView(Context context, AttributeSet attrs) {
        ...
        final TypedArray attributes = context.getTheme().obtainStyledAttributes(attrs, com.vaiha.LemmeShowU.R.styleable.WaveView, com.vaiha.LemmeShowU.R.attr.waveViewStyle, 0);
        mAboveWaveColor = attributes.getColor(com.vaiha.LemmeShowU.R.styleable.WaveView_above_wave_color, DEFAULT_ABOVE_WAVE_COLOR);
        mBlowWaveColor = attributes.getColor(com.vaiha.LemmeShowU.R.styleable.WaveView_blow_wave_color, DEFAULT_BLOW_WAVE_COLOR);
        mProgress = attributes.getInt(com.vaiha.LemmeShowU.R.styleable.WaveView_progress, DEFAULT_PROGRESS);
        mWaveHeight = attributes.getInt(com.vaiha.LemmeShowU.R.styleable.WaveView_wave_height, MIDDLE);
        mWaveMultiple = attributes.getInt(com.vaiha.LemmeShowU.R.styleable.WaveView_wave_length, LARGE);
        mWaveHz = attributes.getInt(com.vaiha.LemmeShowU.R.styleable.WaveView_wave_hz, MIDDLE);
        attributes.recycle();
