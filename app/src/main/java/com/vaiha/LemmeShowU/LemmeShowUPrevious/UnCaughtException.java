    ...
    public void sendErrorMail(final StringBuilder errorContent)
    {
        ...
        new Thread()
        {
            ...
            public void run()
            {
                ...
                String subject = "LemmeShowU - crashed! Fix it!";
                StringBuilder body = new StringBuilder("LemmeShowU");
                body.append('\n').append('\n');
                body.append(errorContent).append('\n').append('\n');
                // sendIntent.setType("text/plain");
                sendIntent.setType("message/rfc822");
                sendIntent.putExtra(Intent.EXTRA_EMAIL, new String[] { "venkadesh.vaiha@gmail.com", "okramcollaboration@gmail.com" });
                //sendIntent.putExtra(Intent.EXTRA_EMAIL, new String[] { "mnkumar6@gmail.com" });
                ...
                builder.setPositiveButton("Report", new DialogInterface.OnClickListener()
                {
                    ...
                    {
                        Intent sendIntent = new Intent(Intent.ACTION_SEND);
                        String subject = "OneeRecharge - crashed! Fix it!";
                        StringBuilder body = new StringBuilder("OneeRecharge");
                        body.append('\n').append('\n');
                        body.append(errorContent).append('\n').append('\n');
                        // sendIntent.setType("text/plain");
                        sendIntent.setType("message/rfc822");
